...
class Menu:
    def greet():
        ...
        print("You will be given a list of Arcana options to choose from. By choosing your desired Arcana, I show show you the Personas of that Arcana type!")
        print()
        ...
        if arcana_choice in valid_arcanas:
            ...
            if valid_arcana_choice:
                if arcana_choice == valid_arcanas[0]:
                    ...
                    Personas.display_justice_persona()
                    Personas.space_lines()
