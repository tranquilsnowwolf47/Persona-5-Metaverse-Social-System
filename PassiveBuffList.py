...
self_control = PassiveBuffSkills("Self-Control", "Passive Def Buff | Auto-Rakukaja effect", 8,
...
human_nature_savant = PassiveBuffSkills("Human Nature Savant", "Passive Ag Buff | Auto-Sukukaja effect", 8,
...
looksmax = PassiveBuffSkills("Looksmax", "Passive Buff | effect", 30,
