...
# Heavy Skills 
shadow_whisper = HeavySkills("Shadow Whisper", "Psy", "Heavy", 23,
"""   - Step back and let the target expose their inner self, including their repressed thoughts and hidden desires. 
By observing without interference, you gain deep insight into their true intentions, fears, and vulnerabilities, revealing patterns they may not even be consciously aware of. 
This allows you to anticipate reactions, exploit weaknesses, and plan your next move with precision. The skill transforms subtle cues into actionable information, giving you a clear strategic advantage.
Ex: Watching someone react to another person’s success or failure, you notice a fleeting expression of envy or frustration. Shadow Whisper uncovers a fear of being left behind or alone.
Ex 2: A person overreacts to a comment about their past. Shadow Whisper lets you see the repressed trauma or insecurity driving their actions. 
...
By recognizing the moment intent forms, you gain clarity on what they are about to do, say, or bring up, allowing you to act with precision and awareness.
(Ex: A target subtly tenses before moving. Foresight reveals they are about to attack.
Ex 2: In conversation, the target pauses and shifts tone. Foresight shows they are about to lie, deflect, or change the topic.
Ex 3: You sense a shift in energy before words are spoken. Foresight reveals the topic or emotional direction they are about to bring up).
Deals heavy Psy damage.""")

signal_decode = HeavySkills("Signal Decode", "Psy", "Heavy", 22,
"""   - Read and interpret indirect cues a target gives off, including chosen signals, subtle hints, and non-verbal communication. 
By recognizing what is implied rather than stated, you uncover the target’s true intent, expectations, and direction in the moment. 
This allows you to respond before the signal fully lands, turning indirect communication into a decisive opening and shifting control in your favor.
(Ex: A target gives a vague or indirect response. Signal Decode reveals the real meaning behind it, allowing you to address it directly before they can maintain ambiguity.
Ex 2: Someone uses tone or wording to imply interest, disinterest, or judgment. Signal Decode exposes the intent and lets you respond in a way that forces clarity or reaction.
Ex 3: A target drops a subtle hint or tests the waters. Signal Decode reveals the underlying expectation, allowing you to act on it before they escalate).
Deals heavy Psy damage.""")
...
# Medium Skills 
echo_esper = MediumSkills("Echo Esper", "Psy", "Medium", 11,
"""   - Repeat and mirror the subject of what a target says while listening, reinforcing their focus and encouraging them to expand on their thoughts. 
By reflecting their words back to them, you draw out deeper information, clarify intent, and keep them engaged, making their thinking more visible and easier to follow.
Ex: A target mentions being stressed about work. Echo Esper repeats the subject, prompting them to elaborate on what’s causing it.
Ex 2: In conversation, the target briefly brings up a personal interest. Echo Esper highlights it, leading them to open up further.
Ex 3: A target makes a vague statement. Echo Esper repeats the core subject, encouraging them to clarify and reveal more detail.
Deals medium Psy damage.""")

soulstring_pull = MediumSkills("Soulstring Pull", "Psy", "Medium", 10,
...
atmosphere_read = MediumSkills("Atmosphere Read", "Psy", "Medium", 13,
...
atmos_gauge = MediumSkills("Atmos Gauge", "Psy", "Medium", 14,
...
tranquil_edge = MediumSkills("Tranquil Edge", "Psy", "Medium", 13,
...
energy_mirror = MediumSkills("Energy Mirror", "Psy", "Medium", 10,
...
kinesis_gap = MediumSkills("Kinesis Gap", "Psy", "Medium", 11,
...
# Light Skills 
interest_gauge = LightSkills("Interest Gauge", "Psy", "Light", 8,
...
temperament_read = LightSkills("Temperament Read", "Psy", "Light", 6,
...
love_interpreter = LightSkills("Love Interpreter", "Psy", "Light", 6,
...
sixth_observation = LightSkills("Sixth Observation", "Psy", "Light", 7,
...
name_echo = LightSkills("Name Echo", "Psy", "Light", 5,
...
severe_skills = ()
heavy_skills = (shadow_whisper, priority_rift, foresight, signal_decode, prioritized_presence)
medium_skills = (echo_esper, soulstring_pull, atmosphere_read, atmos_gauge, tranquil_edge, energy_mirror, kinesis_gap)
