...
class AffinityPassiveSkills(PassiveSkills):
    pass

class PassiveSkills(PassiveSkills):
    pass

class StatusAilmentPassiveSkills(PassiveSkills):
    pass
...
evade_reverse_phys = AffinityPassiveSkills("Evade Reverse Phys", "Affinity Passive", "N/A",
...
evade_reverse_gun = AffinityPassiveSkills("Evade Reverse Gun", "Affinity Passive", "N/A",
...
evade_reverse_fire = AffinityPassiveSkills("Evade Reverse Fire", "Affinity Passive", "N/A",
...
evade_reverse_ice = AffinityPassiveSkills("Evade Reverse Ice", "Affinity Passive", "N/A",
...
evade_reverse_elec = AffinityPassiveSkills("Evade Reverse Elec", "Affinity Passive", "N/A",
...
evade_reverse_wind = AffinityPassiveSkills("Evade Reverse Wind", "Affinity Passive", "N/A",
...
evade_reverse_psy = AffinityPassiveSkills("Evade Reverse Psy", "Affinity Passive", "N/A",
...
evade_reverse_nuke = AffinityPassiveSkills("Evade Reverse Nuke", "Affinity Passive", "N/A",
...
evade_reverse_bless = AffinityPassiveSkills("Evade Reverse Bless", "Affinity Passive", "N/A",
...
evade_reverse_curse = AffinityPassiveSkills("Evade Reverse Curse", "Affinity Passive", "N/A",
...
# Reists skills 
resist_phys = AffinityPassiveSkills("Resist Phys", "Affinity Passive", "N/A",
...
resist_gun = AffinityPassiveSkills("Resist Gun", "Affinity Passive", "N/A",
...
resist_fire = AffinityPassiveSkills("Resist Fire", "Affinity Passive", "N/A",
...
resist_ice = AffinityPassiveSkills("Resist Ice", "Affinity Passive", "N/A",
...
resist_elec = AffinityPassiveSkills("Resist Elec", "Affinity Passive", "N/A",
...
resist_wind = AffinityPassiveSkills("Resist Wind", "Affinity Passive", "N/A",
...
resist_psy = AffinityPassiveSkills("Resist Psy", "Affinity Passive", "N/A",
...
resist_nuke = AffinityPassiveSkills("Resist Nuke", "Affinity Passive", "N/A",
...
resist_bless = AffinityPassiveSkills("Resist Bless", "Affinity Passive", "N/A",
...
resist_curse = AffinityPassiveSkills("Resist Curse", "Affinity Passive", "N/A",
...
resist_reverse_phys = AffinityPassiveSkills("Resist Reverse Phys", "Affinity Passive", "N/A",
...
resist_reverse_gun = AffinityPassiveSkills("Resist Reverse Gun", "Affinity Passive", "N/A",
...
resist_reverse_fire = AffinityPassiveSkills("Resist Reverse Fire", "Affinity Passive", "N/A",
...
resist_reverse_ice = AffinityPassiveSkills("Resist Reverse Ice", "Affinity Passive", "N/A",
...
resist_reverse_elec = AffinityPassiveSkills("Resist Reverse Elec", "Affinity Passive", "N/A",
...
resist_reverse_wind = AffinityPassiveSkills("Resist Reverse Wind", "Affinity Passive", "N/A",
...
resist_reverse_psy = AffinityPassiveSkills("Resist Reverse Psy", "Affinity Passive", "N/A",
...
resist_reverse_nuke = AffinityPassiveSkills("Resist Reverse Nuke", "Affinity Passive", "N/A",
...
resist_reverse_bless = AffinityPassiveSkills("Resist Reverse Bless", "Affinity Passive", "N/A",
...
resist_reverse_curse = AffinityPassiveSkills("Resist Reverse Curse", "Affinity Passive", "N/A",
...
# Null skills 
null_phys = AffinityPassiveSkills("Null Phys", "Affinity Passive", "N/A",
...
null_gun = AffinityPassiveSkills("Null Gun", "Affinity Passive", "N/A",
...
null_fire = AffinityPassiveSkills("Null Fire", "Affinity Passive", "N/A",
...
null_ice = AffinityPassiveSkills("Null Ice", "Affinity Passive", "N/A",
...
null_elec = AffinityPassiveSkills("Null Elec", "Affinity Passive", "N/A",
...
""")
null_wind = AffinityPassiveSkills("Null Wind", "Affinity Passive", "N/A",
...
null_psy = AffinityPassiveSkills("Null Psy", "Affinity Passive", "N/A",
...
null_nuke = AffinityPassiveSkills("Null Nuke", "Affinity Passive", "N/A",
...
null_bless = AffinityPassiveSkills("Null Bless", "Affinity Passive", "N/A",
...
null_curse = AffinityPassiveSkills("Null Curse", "Affinity Passive", "N/A",
...
null_reverse_phys = AffinityPassiveSkills("Null Reverse Phys", "Affinity Passive", "N/A",
...
null_reverse_gun = AffinityPassiveSkills("Null Reverse Gun", "Affinity Passive", "N/A",
...
null_reverse_fire = AffinityPassiveSkills("Null Reverse Fire", "Affinity Passive", "N/A",
...
null_reverse_ice = AffinityPassiveSkills("Null Reverse Ice", "Affinity Passive", "N/A",
...
null_reverse_elec = AffinityPassiveSkills("Null Reverse Elec", "Affinity Passive", "N/A",
...
null_reverse_wind = AffinityPassiveSkills("Null Reverse Wind", "Affinity Passive", "N/A",
...
null_reverse_psy = AffinityPassiveSkills("Null Reverse Psy", "Affinity Passive", "N/A",
...
null_reverse_nuke = AffinityPassiveSkills("Null Reverse Nuke", "Affinity Passive", "N/A",
...
null_reverse_bless = AffinityPassiveSkills("Null Reverse Bless", "Affinity Passive", "N/A",
...
null_reverse_curse = AffinityPassiveSkills("Null Reverse Curse", "Affinity Passive", "N/A",
...
# Drain
drain_phys = AffinityPassiveSkills("Drain Phys", "Affinity Passive", "N/A",
...
drain_gun = AffinityPassiveSkills("Drain Gun", "Affinity Passive", "N/A",
...
drain_fire = AffinityPassiveSkills("Drain Fire", "Affinity Passive", "N/A",
...
drain_ice = AffinityPassiveSkills("Drain Ice", "Affinity Passive", "N/A",
...
drain_elec = AffinityPassiveSkills("Drain Elec", "Affinity Passive", "N/A",
...
drain_wind = AffinityPassiveSkills("Drain Wind", "Affinity Passive", "N/A",
...
""")
drain_psy = AffinityPassiveSkills("Drain Psy", "Affinity Passive", "N/A",
...
drain_nuke = AffinityPassiveSkills("Drain Nuke", "Affinity Passive", "N/A",
...
drain_bless = AffinityPassiveSkills("Drain Bless", "Affinity Passive", "N/A",
...
drain_curse = AffinityPassiveSkills("Drain Curse", "Affinity Passive", "N/A",
...
drain_reverse_phys = AffinityPassiveSkills("Drain Reverse Phys", "Affinity Passive", "N/A",
...
drain_reverse_gun = AffinityPassiveSkills("Drain Reverse Gun", "Affinity Passive", "N/A",
...
drain_reverse_fire = AffinityPassiveSkills("Drain Reverse Fire", "Affinity Passive", "N/A",
...
drain_reverse_ice = AffinityPassiveSkills("Drain Reverse Ice", "Affinity Passive", "N/A",
...
drain_reverse_elec = AffinityPassiveSkills("Drain Reverse Elec", "Affinity Passive", "N/A",
...
drain_reverse_wind = AffinityPassiveSkills("Drain Reverse Wind", "Affinity Passive", "N/A",
...
drain_reverse_psy = AffinityPassiveSkills("Drain Reverse Psy", "Affinity Passive", "N/A",
...
drain_reverse_nuke = AffinityPassiveSkills("Drain Reverse Nuke", "Affinity Passive", "N/A",
...
drain_reverse_bless = AffinityPassiveSkills("Drain Reverse Bless", "Affinity Passive", "N/A",
...
drain_reverse_curse = AffinityPassiveSkills("Drain Reverse Curse", "Affinity Passive", "N/A",
...
# Repel
repel_phys = AffinityPassiveSkills("Repel Phys", "Affinity Passive", "N/A",
...
repel_gun = AffinityPassiveSkills("Repel Gun", "Affinity Passive", "N/A",
...
repel_fire = AffinityPassiveSkills("Repel Fire", "Affinity Passive", "N/A",
...
repel_ice = AffinityPassiveSkills("Repel Ice", "Affinity Passive", "N/A",
...
repel_elec = AffinityPassiveSkills("Repel Elec", "Affinity Passive", "N/A",
...
repel_wind = AffinityPassiveSkills("Repel Wind", "Affinity Passive", "N/A",
...
repel_psy = AffinityPassiveSkills("Repel Psy", "Affinity Passive", "N/A",
...
repel_nuke = AffinityPassiveSkills("Repel Nuke", "Affinity Passive", "N/A",
...
repel_bless = AffinityPassiveSkills("Repel Bless", "Affinity Passive", "N/A",
...
repel_curse = AffinityPassiveSkills("Repel Curse", "Affinity Passive", "N/A",
...
repel_reverse_phys = AffinityPassiveSkills("Repel Reverse Phys", "Affinity Passive", "N/A",
...
repel_reverse_gun = AffinityPassiveSkills("Repel Reverse Gun", "Affinity Passive", "N/A",
...
repel_reverse_fire = AffinityPassiveSkills("Repel Reverse Fire", "Affinity Passive", "N/A",
...
repel_reverse_ice = AffinityPassiveSkills("Repel Reverse Ice", "Affinity Passive", "N/A",
...
repel_reverse_elec = AffinityPassiveSkills("Repel Reverse Elec", "Affinity Passive", "N/A",
...
repel_reverse_wind = AffinityPassiveSkills("Repel Reverse Wind", "Affinity Passive", "N/A",
...
repel_reverse_psy = AffinityPassiveSkills("Repel Reverse Psy", "Affinity Passive", "N/A",
...
repel_reverse_nuke = AffinityPassiveSkills("Repel Reverse Nuke", "Affinity Passive", "N/A",
...
repel_reverse_bless = AffinityPassiveSkills("Repel Reverse Bless", "Affinity Passive", "N/A",
...
repel_reverse_curse = AffinityPassiveSkills("Repel Reverse Curse", "Affinity Passive", "N/A",
...
gun_boost =  PassiveSkills("Gun Boost", "Passive", "N/A",
...
fire_boost = PassiveSkills("Fire Boost", "Passive", "N/A",
...
ice_boost = PassiveSkills("Ice Boost", "Passive", "N/A",
...
elec_boost = PassiveSkills("Elec Boost", "Passive", "N/A",
...
wind_boost = PassiveSkills("Wind Boost", "Passive", "N/A",
...
psy_boost = PassiveSkills("Psy Boost", "Passive", "N/A",
...
nuke_boost = PassiveSkills("Nuke Boost", "Passive", "N/A",
...
bless_boost = PassiveSkills("Bless Boost", "Passive", "N/A",
...
curse_boost = PassiveSkills("Curse Boost", "Passive", "N/A",
...
gun_amp = PassiveSkills("Gun Amp", "Passive", "N/A",
...
fire_amp = PassiveSkills("Fire Amp", "Passive", "N/A",
...
ice_amp = PassiveSkills("Ice Amp", "Passive", "N/A",
...
elec_amp = PassiveSkills("Elec Amp", "Passive", "N/A",
...
wind_amp = PassiveSkills("Wind Amp", "Passive", "N/A",
...
psy_amp = PassiveSkills("Psy Amp", "Passive", "N/A",
...
nuke_amp = PassiveSkills("Nuke Amp", "Passive", "N/A",
...
bless_amp = PassiveSkills("Bless Amp", "Passive", "N/A",
...
curse_amp = PassiveSkills("Curse Amp", "Passive", "N/A",
...
normal_passive_skills = (diamond_mirror, aegis_mirror, regenerate_I, regenerate_II, regenerate_III, invigorate_I, invigorate_II, invigorate_III, gun_boost, fire_boost, ice_boost, elec_boost, wind_boost, psy_boost, nuke_boost, bless_boost, curse_boost,
...
resist_phys, resist_gun, resist_fire, resist_ice, resist_elec, resist_wind, resist_psy, resist_nuke, resist_bless, resist_curse, 
resist_reverse_phys, resist_reverse_gun, resist_reverse_fire, resist_reverse_ice, resist_reverse_elec, resist_reverse_wind, resist_reverse_psy, resist_reverse_nuke, resist_reverse_bless, resist_reverse_curse,
null_phys, null_gun, null_fire, null_ice, null_elec, null_wind, null_psy, null_nuke, null_bless, null_curse, 
null_reverse_phys, null_reverse_gun, null_reverse_fire, null_reverse_ice, null_reverse_elec, null_reverse_wind, null_reverse_psy, null_reverse_nuke, null_reverse_bless, null_reverse_curse,
drain_phys, drain_gun, drain_fire, drain_ice, drain_elec, drain_wind, drain_psy, drain_nuke, drain_bless, drain_curse,
drain_reverse_phys, drain_reverse_gun, drain_reverse_fire, drain_reverse_ice, drain_reverse_elec, drain_reverse_wind, drain_reverse_psy, drain_reverse_nuke, drain_reverse_bless, drain_reverse_curse,
repel_phys, repel_gun, repel_fire, repel_ice, repel_elec, repel_wind, repel_psy, repel_nuke, repel_bless, repel_curse,
repel_reverse_phys, repel_reverse_gun, repel_reverse_fire, repel_reverse_ice, repel_reverse_elec, repel_reverse_wind, repel_reverse_psy, repel_reverse_nuke, repel_reverse_bless, repel_reverse_curse)

# Tuple that holds all Passive skills 
full_passive_skill_list = (normal_passive_skills, affinity_passive_skills)
