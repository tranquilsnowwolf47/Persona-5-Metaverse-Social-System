...
# Heavy Skills
advance_slash = HeavySkills("Advance Slash", "Phys", "Heavy", "20%", 
...
consequence_hammer = HeavySkills("Consequence Hammer", "Phys", "Heavy", "14%",
...
verdict_slice = HeavySkills("Verdict Slice", "Phys", "Heavy", "14%", 
...
hard_check = HeavySkills("Hard Check", "Phys", "Heavy", "14%", 
...
iron_gaze = HeavySkills("Iron Gaze", "Phys", "Heavy", "13%", 
...
# Medium Skills
alpha_directive = MediumSkills("Alpha Directive", "Phys", "Medium", "9%", 
...
bind_blade = MediumSkills("Bind Blade", "Phys", "Medium", "10%",
...
decision_strike = MediumSkills("Opening Gambit", "Phys", "Medium", "9%",
...
calling_fang = LightSkills("Calling Fang", "Phys", "Light", "5%",
